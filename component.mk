...
jars=$(addprefix target/, $(addsuffix .jar, $(build_final_name) $(build_final_name)-sources $(build_final_name)-javadoc))
signatures=$(addsuffix .asc, $(jars))

.PHONY: clean install sign sources javadoc
all: sign
